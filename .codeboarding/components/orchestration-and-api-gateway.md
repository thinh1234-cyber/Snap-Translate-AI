---
component_id: 2
component_name: Orchestration & API Gateway
---
...
The central hub of the extension (Background Service Worker). It coordinates communication between the UI, the processing engines, and external AI services. It manages state, handles cross-origin API requests to OpenAI, and routes tasks based on user configuration.
